      ...
      <div className="pt-0 space-y-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4 text-slate-700 font-bold text-lg">
            <span className="w-5 h-5 flex items-center justify-center">
              <div
                className="w-4 h-4 rounded-full border-2 border-slate-400 border-t-transparent animate-spin duration-[3s]"
                style={{ animationPlayState: 'paused', borderTopColor: 'inherit' }}
              ></div>
            </span>
            進行中的專案
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-base-200 p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">文獻庫概覽</h2>
            <button
          ...
          <div className="space-y-1">
            {documents.map((doc) => (
              <div
                key={doc.id}
                className="group flex items-center justify-between p-3 hover:bg-slate-50 rounded-lg transition-colors border-b border-transparent hover:border-slate-100 last:border-0"
              >
